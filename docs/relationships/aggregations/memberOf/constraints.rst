...
.. _memberOf-constraints-c2:

**C2:** The classifier connected to the whole end must be a «:ref:`collective`». The classifier connected to the part end can be either a «:ref:`collective`» or **functional complex**.
