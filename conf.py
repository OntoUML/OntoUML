...
htmlhelp_basename = 'OntoUML Specification'
...
man_pages = [
    (master_doc, 'ontoumlspecification', 'OntoUML specification Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OntoUMLspecification', 'OntoUML specification Documentation',
     author, 'OntoUMLspecification', 'One line description of project.',
     'Miscellaneous'),
]
